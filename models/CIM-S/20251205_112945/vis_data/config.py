...
custom_hooks = [
    dict(priority='VERY_LOW', type='EvaluateModel'),
]
custom_imports = dict(
...
width_per_channel = 4
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MIDL26/work_dir/Best_ParallelResNet'
